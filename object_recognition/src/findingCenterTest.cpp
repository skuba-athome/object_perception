...
#include <object_recognition_new/classifyObject.h>
#include <object_recognition_new/verifyObject.h>
#include <object_recognition_new/Object.h>
#include <object_recognition_new/ObjectContainer.h>
#include <object_recognition_new/findObject.h>
...
std::string output_dir = "/home/mukda/catkin_athome/src/object_recognition_new/object_perception/";

// service client
ros::ServiceClient classifyClient;
object_recognition_new::classifyObject classifySrv;
...
//void getObjectPoint(object_recognition_new::findObject::Response &res)
bool getObjectPoint(object_recognition_new::findObject::Request &req, object_recognition_new::findObject::Response &res)
//void getObjectPoint()
{
...
///     plane_name << "/run/shm/object_perception/segmenged_plane" << j << ".pcd";
    ...
    for(int k=0;k<objectNumber;k++)
    {
        ...
        if(classifyClient.call(classifySrv))
        {
            ...
            /*
            object_recognition_new::Object object;
            ...
            */
            ...
            res.objectPositionXYZ.push_back(objectCentroidWorld[k][0]);
            res.objectPositionXYZ.push_back(objectCentroidWorld[k][1]);
            res.objectPositionXYZ.push_back(objectCentroidWorld[k][2]);
...
int main (int argc, char** argv)
{
    ...
    classifyClient = n.serviceClient<object_recognition_new::classifyObject>("classifyObject");
